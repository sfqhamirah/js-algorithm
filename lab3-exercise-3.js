...
const checkAnagram = (inputString1, inputString2) => {    
  ...
  stringArray1 = inputString1.toLowerCase().split("")
  stringArray2 = inputString2.toLowerCase().split("")

  const sortedArray1 = stringArray1.sort()
  const sortedArray2 = stringArray2.sort()
