...
// Test Cases
assert.deepStrictEqual(findPairs([7, 2, 3, 9, 1], 10).sort(), [[7, 3], [9, 1]], "Test case 1 output is wrong.")
assert.deepStrictEqual(findPairs([2, 4, 1, 8, 9], 2).sort(), [], "Test case 2 output is wrong.")
assert.deepStrictEqual(findPairs([7, 2, 3, 9], 10), [[7, 3]], "Test case 3 output is wrong.")
